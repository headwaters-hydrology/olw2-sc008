window.dashExtensions = Object.assign({}, window.dashExtensions, {
    default: {
        ...
        rivers_catch_style_handle_hfl_sites: function style(feature) {
            return {
                fillColor: 'grey',
                weight: 2,
                opacity: 1,
        ...
        rivers_base_reach_style_handle_hfl_sites: function style3(feature) {
            return {
                weight: 2,
                opacity: 0.75,
                color: 'grey',
        ...
        rivers_sites_points_handle_hfl_sites: function rivers_sites_points_handle(feature, latlng, context) {
            const {
                classes,
                colorscale,
                circleOptions,
        ...
        rivers_hfl_sites_marae_handle: function(feature, latlng) {
            const flag = L.icon({
                iconUrl: '/assets/nzta-marae.svg',
                iconSize: [20, 30]
            });
