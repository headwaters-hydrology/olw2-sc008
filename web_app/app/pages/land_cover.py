                            ...
                            dmc.AccordionItem([
                                ...
                                dmc.AccordionPanel([
                                    ...
                                    dmc.HoverCard(
                                        ...
                                        children=[
                                            dmc.HoverCardTarget(dcc.Markdown('(3b) Select the percentage of the maximum contaminant loss reductions applied for the river reaches (❓):', style={'margin-top': 20})),
