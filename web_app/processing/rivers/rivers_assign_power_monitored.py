...
def rivers_process_power_monitored():
    ...
    conc0 = pd.read_csv(utils.river_errors_moni_path)
    ...
    for ind, grp in grp1:
        ...
        for catch_id in starts:
            ...
            r_errors = pd.merge(df1, grp, on='nzsegment').set_index('nzsegment')['error']
    ...
    hdf5tools.xr_to_hdf5(combo, utils.river_power_moni_path)
